...
## Example 3 - Open DB access mode (allow any source)
...
SSO configuration is manual in GLPI/IdP and is intentionally not represented as script-driven `AUTH_*`/`SSO_*` examples.
