...
| SAN | Must include the FQDN used by `GLPI_DOMAIN` and `SSO_PUBLIC_URL`. May include approved aliases. |
...
| Subject Alternative Name | `DNS:glpi.company.com` and approved aliases. |
