...
This section is technical reference content.

For operational guided execution, start at:

- [Operator Manual (EN Canonical)](../user-manual.md)
- [Guided Chapters](../guide/01-start-and-prechecks.md)

Use these appendices when you need deeper details while executing or troubleshooting.

## Configuration and Installation

- [Environment Configuration Field Guide](configuration-field-guide.md)
